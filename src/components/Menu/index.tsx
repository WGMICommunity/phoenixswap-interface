...
const items = (i18n: I18n) => [
  {
    name: i18n._(t`Docs`),
    description: i18n._(t`Documentation for users of Phoenix.`),
    href: 'https://docs.sushi.com',
  },
  {
    name: i18n._(t`Dev`),
    description: i18n._(t`Documentation for developers of Phoenix.`),
    href: 'https://dev.sushi.com',
  },
  {
    name: i18n._(t`Open Source`),
    description: i18n._(t`Phoenix is a supporter of Open Source.`),
