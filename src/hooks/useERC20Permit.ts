import { Currency, CurrencyAmount, JSBI, Percent, Token, TradeType, Trade as V2Trade } from '@phoenixswapv2/core-sdk'
...
const PERMITTABLE_TOKENS: {
  ...
  [1]: {
    ...
    [SUSHI[1].address]: { type: PermitType.AMOUNT, name: 'Phoenixswap' },
  },
  [4]: {
    ...
    [SUSHI[4].address]: { type: PermitType.AMOUNT, name: 'Phoenixswap' },
  },
  [3]: {
    [SUSHI[3].address]: { type: PermitType.AMOUNT, name: 'Phoenixswap' },
  ...
  [5]: {
    [SUSHI[5].address]: { type: PermitType.AMOUNT, name: 'Phoenixswap' },
  },
  [42]: {
    [SUSHI[42].address]: { type: PermitType.AMOUNT, name: 'Phoenixswap' },
  },
}
